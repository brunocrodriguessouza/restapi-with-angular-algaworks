...
INSERT INTO people (name, street, number, complement, neighborhood, zipcode, city, state, active) values ('Miguel Souza', 'Rua dos Alecrins', '10', null, 'Cambuí', '13.058-000', 'Campinas', 'SP', false);
INSERT INTO people (name, street, number, complement, neighborhood, zipcode, city, state, active) values ('Ana Júlia', 'Rua dos Alecrins', '10', null, 'Cambuí', '13.058-000', 'Campinas', 'SP', false);
